          ...
          {step === 'choose-role' && (
            <motion.div key="role" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -40 }} className="space-y-5">
              <div className="text-center space-y-1">
                <h2 className="text-[24px] font-extrabold text-ink tracking-tight">Join Plot</h2>
                <p className="text-[14px] text-smoke">How do you want to use Plot?</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-smoke">Claim your Plot link, add pins, grow your audience</p>
                  </div>
                </motion.button>
          ...
          {step === 'claim-username' && (
            <motion.div key="username" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -40 }} className="space-y-5">
              ...
              <div className="text-center space-y-1">
                ...
                <h2 className="text-[24px] font-extrabold text-ink tracking-tight">Claim your Plot</h2>
                <p className="text-[14px] text-smoke">Choose your unique link</p>
              </div>

              {/* URL preview */}
              <div className="bg-cream rounded-[14px] px-4 py-3">
                <p className="text-[12px] text-smoke font-medium mb-0.5">Your Plot link</p>
                <p className="text-[17px] font-bold text-ink">
                  plot.app/<span className={username ? 'text-tangerine' : 'text-ash'}>{username || '...'}</span>
                </p>
              </div>
          ...
          {step === 'create-account' && (
            <motion.div key="create" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -40 }} className="space-y-5">
              ...
              <div className="text-center space-y-1">
                ...
                {role === 'agent' && username && (
                  <p className="text-[14px] text-smoke">Securing <span className="text-tangerine font-bold">plot.app/{username}</span></p>
                )}
              </div>

      ...
      >
        ...
        {BUILDINGS.map((b, i) => (
          <motion.div
            key={`bldg-${i}`}
            className="absolute"
            style={{ top: b.top, left: b.left, width: b.w, height: b.h, aspectRatio: `${b.w}/${b.h}` }}
